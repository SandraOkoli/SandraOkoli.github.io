      ...
      <div className="row">
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p>Users are able to create an event by searching for a location via Google Maps and Google Places or join an event and interact with other attendees via comments. I was tasked with testing (using Mocha, Chai and Istanbul), creating the comments functionality, created two of the RESTful routes and styled the show page.</p>
            <div className="logos">
