      ...
      <div className="row">
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p>Using jQuery and DOM manipulation, players can choose between three Kardashians to feature in the game. Using mouse clicks, the user must slap a Kardashian as they appear before the time runs out. Each time a Kardashian is successfully hit, the score is incremented by 10 points. If a user fails to click on time and the score is greater than 0 the score is decremented by five points. The game gets faster each time the user goes up a level.</p>
            <div className="logos">
